...
from applications.utils import mkdir_p, generate_session_id
from applications.utils import convert_to_timedelta
from applications.utils import total_seconds
...
class NullAuthHandler(BaseAuthHandler):
    ...
    def get(self):
        ...
        """
        user = {'upn': 'ANONYMOUS'}#AnonymousUser
