...
urlpatterns = [
    ...
    url(r'^terminal/static/(?P<path>.*)$', serve,{'document_root': [os.path.join(settings.BASE_DIR,'applications/static/'),os.path.join(settings.BASE_DIR,'applications/templates/')]}),
